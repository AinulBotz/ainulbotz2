...
async function connectionUpdate(update) {
  ...
  if (update.receivedPendingNotifications) conn.sendMessage(`6285754202785@s.whatsapp.net`, {text: 'Bot Sudah Berhasil Terhubung' })
}
...
global.reloadHandler = function (restatConn) {
  ...
  conn.welcome = '@user Baru Saja Memasuki Grup @subject\nYahh! Beban nya nambah deh:(Selamat Datang Wahai Beban\n*Intro Dulu Yuk*\n\n*Nama:*\n*Umur:*\n*Askot:*\n\n*Deskripsi Grup:*\n\n@desc️' 
  conn.bye = 'Yey Beban Berkurang @user 👋'
